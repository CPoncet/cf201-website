          ...
          <div className="text w-3/4 flex items-center justify-center ml-8">
            <div>
              ...
              <p>
                ...
                sont là pour lui donner vie. En vous accompagnant dès les
...
export async function getStaticProps(context) {
  const refs = await fetch(`${process.env.API_URL}/clients`);
  ...
  return {
    props: {
      references: references.sort(getSortOrder("acf", "customer_popularity")),
      services,
    },
  };
}
